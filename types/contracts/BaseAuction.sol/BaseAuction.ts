...
export interface BaseAuctionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "auctionDescription"
...
export interface BaseAuction extends BaseContract {
  connect(runner?: ContractRunner | null): BaseAuction;
  waitForDeployment(): Promise<this>;

  interface: BaseAuctionInterface;
