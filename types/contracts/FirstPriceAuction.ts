...
export interface FirstPriceAuctionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "auctionDescription"
  ...
  encodeFunctionData(
    functionFragment: "encryptedWinningBid",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getEncryptedWinningBid",
    values?: undefined
  ): string;
...
export interface FirstPriceAuction extends BaseContract {
  connect(runner?: ContractRunner | null): FirstPriceAuction;
  waitForDeployment(): Promise<this>;

  interface: FirstPriceAuctionInterface;
  ...
  encryptedWinningBid: TypedContractMethod<[], [string], "view">;
  ...
  getEncryptedWinningBid: TypedContractMethod<[], [string], "view">;
  ...
  revealWinner: TypedContractMethod<
    [
      decryptedIndex: BigNumberish,
      decryptedBid: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "encryptedWinningBid"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "getEncryptedWinningBid"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
